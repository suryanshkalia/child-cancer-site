      ...
      <main className="flex max-w-7xl mx-auto flex-col p-10">
        ...
        <section className="flex flex-col gap-20">
          ...
          <div className="flex gap-10 justify-between">
            ...
            <div>
              <img src={symptoms} alt="Child hood cancer symptoms" />
            </div>
          </div>
          <div className="flex flex-col gap-10">
            ...
            {types.map((item, index) => (
              <div className="max-w-lg shadow-lg border border-gray-900 p-6" >
                 <h1 className="text-xl mb-5" key={index} >{item.title}</h1>
